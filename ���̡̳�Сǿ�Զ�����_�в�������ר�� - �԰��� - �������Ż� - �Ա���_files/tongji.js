...
{
	var unit_id     = "2736704";
	var client_ip   = "220.170.91.72";
	var server_time = "1391942374";
	var verify_code = "777c177b";
	var type        = "3";
...
document.write("<img src=\""+dest+"\" border=\"0\" width=\"1\" height=\"1\" />");
	...
	var icon_link_host="tongji.linezing.com";
        ...
        if(url_id>0)
                document.write('<scr'+'ipt src=\'http://js.tongji.linezing.com/2736704/'+url_id+'/clickcollect.js\'></scr'+'ipt>');
}
